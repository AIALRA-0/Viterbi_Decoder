...
module tb_viterbi_soft3;
  logic clk;
  logic rst;
  logic start;
  logic in_valid;
  logic [SOFT_WIDTH_BITS-1:0] rx_soft;
  logic in_ready;
  logic out_valid;
  logic out_bit;
  ...
  logic [SOFT_WIDTH_BITS-1:0] rx_soft_values [0:CODE_BITS-1];
  ...
  viterbi_decoder_core_soft3 dut (
    .clk(clk),
    .rst(rst),
    .start(start),
    .in_valid(in_valid),
