...
def main() -> int:
    ...
    soft_width = int(spec["decoder"]["soft_width_bits"])
    hero_metric_width = int(spec["decoder"]["default_hero"]["path_metric_width"])
...
package viterbi_pkg;
  ...
  localparam int SOFT_WIDTH_BITS = {soft_width};
  ...
  localparam int HERO_METRIC_WIDTH = {hero_metric_width};
